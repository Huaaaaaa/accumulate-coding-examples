 ...
 */
public class GitProtoTypeClient {
    public static void main(String[] args) {
        ...
        while (scanner.hasNext()) {
            ...
            if (next.equals("git-logs")) {
                List<OriginatorCommit> currentBranchCommitLogs = caretakerCommitLog.getCurrentBranchCommitLogs();
                ...
                OriginatorCommit currentBranchCommitLog = caretakerCommitLog.getCurrentBranchCommitLog(commitId);
                ...
                //备份提交
                OriginatorCommit memento = originatorCommit.createMemento();
                //管理备份
